...
def test_valid_initialization(health, firepower, armor):
    ...
    assert unit.get_health() == health
    assert unit.get_firepower() == firepower
    assert unit.get_armor() == armor
...
def test_shot_by(a_health, a_firepower, a_armor, b_health, b_armor, b_firepower, expected_b_health):
    ...
    # Assert
    assert expected_b_health == unit_b.get_health()
    assert a_health == unit_a.get_health()
    assert a_firepower == unit_a.get_firepower()
    assert a_armor == unit_a.get_armor()
    assert b_firepower == unit_b.get_firepower()
    assert b_armor == unit_b.get_armor()
